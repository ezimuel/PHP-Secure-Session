...
class SecureSession {
	...
	*/
	...
	public function read( $id ) {
		...
		$decrypt = mcrypt_decrypt( $this->_algo, $this->_key, $encrypted, MCRYPT_MODE_CBC, $iv );
	...
	public function write( $id, $data ) {
		...
		$bytes = file_put_contents( $sessFile, $hmac . ':' . base64_encode( $iv ) . ':' . base64_encode( $encrypted ) );
